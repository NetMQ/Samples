const string LRUReady = "READY";
const string FrontendEndpoint = "tcp://localhost:5555";
const string BackendEndpoint = "tcp://localhost:5556";

var frontend = new RouterSocket();
var backend = new RouterSocket();
